...
server_support_checksum=73c0bda2418cb5ea53eaa36e9dece4eadc2b8506149082c3725f6310421c1c74
...
assert_contains "server-support source pins version 0.1.3" 'PluginVersion = "0.1.3"' "$server_support_source"
assert_contains \
...
printf '%s\n' \
  ...
  'Benheim Server Support 0.1.3 loaded with Put Away and confirmed-kill coordination.' \
  > "$tmp_dir/journal.log"
