...
kill_rules="$root/client-mods/benheim/src/KillAttribution/KillChainRules.cs"
kill_delivery_attempt="$root/client-mods/benheim/src/KillAttribution/KillAttributionRpcAttempt.cs"
kill_qualification="$mod/src/VictimQualification.cs"
protocol="$root/shared/benheim-inventory-protocol"
client="$root/client-mods/benheim/src/Inventory/PutAwayLeaseClient.cs"
quick_stack="$root/client-mods/benheim/src/Inventory/QuickStack.cs"
quick_stack_completion="$root/client-mods/benheim/src/Inventory/QuickStackCompletion.cs"
