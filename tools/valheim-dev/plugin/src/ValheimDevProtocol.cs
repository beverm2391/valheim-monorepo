...
internal sealed class ValheimDevSessionIdentity
{
    ...
    internal string ValheimDevVersion { get; set; } = string.Empty;
    internal string ValheimDevSha256 { get; set; } = string.Empty;
...
internal sealed class ValheimDevResponse
{
    ...
    internal bool EvidenceAvailable { get; set; }
    internal string? EvidenceUnavailableReason { get; set; }
    ...
    internal string ToJson(bool includeOperation)
    {
        ...
        builder.Append(',');
        ValheimDevJson.AppendProperty(builder, "valheim_dev_version", Identity.ValheimDevVersion);
        builder.Append(',');
        ValheimDevJson.AppendProperty(builder, "valheim_dev_sha256", Identity.ValheimDevSha256);
        builder.Append(',');
        ...
        if (includeOperation)
        {
            ...
            builder.Append(',');
            ValheimDevJson.AppendProperty(builder, "evidence_available", EvidenceAvailable);
            builder.Append(',');
            ValheimDevJson.AppendNullableProperty(builder, "evidence_unavailable_reason", EvidenceUnavailableReason);
            builder.Append(',');
