...
internal static class WorldLabelRuntime
{
    ...
    internal static void Attach(Sign sign)
    {
        if (sign.m_textWidget == null ||
            ...
            sign.GetComponent<SignGlowController>() != null)
        {
            return;
        }
    ...
    internal static void LogNativeDonorPending()
    {
        ...
        Plugin.Log.LogWarning(
            "Portal labels are waiting for Valheim's native piece_sign text donor.");
    }
