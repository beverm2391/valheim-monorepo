...
For this experiment, a native administrator using a compatible Benheim client
can request an ordinary Boar as a control or request a one-star or two-star
native Boar. This requires Benheim Test Commands `0.1.4` on the dedicated
server.
[Benheim Test Commands](../../../../server-mods/benheim-test-commands/PRODUCT.md)
