...
grep -Fq 'DiagnosticEvent.Create("Health", "patch_group_disabled")' "$health"
grep -Fq 'DiagnosticEvent.Create("Health", "partial_patch_cleanup_failed")' "$health"
grep -Fq 'DiagnosticEvent.Create("Health", "partial_patches_removed")' "$health"
