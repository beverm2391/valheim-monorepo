...
grep -Fq 'package.Write(material.m_cheated);' "$remote_batch"
grep -Fq 'cheated = package.ReadBool();' "$remote_batch"
grep -Fq 'QueueOre.Invoke(station, new object[] { prefab, cheated });' "$remote_batch"
