...
grep -Fq '!AdrenalineAvailability.IsUnlocked(localPlayer)' "$client/KillAttributionClient.cs"
grep -Fq 'EmitReport(operationId, observation, "not_sent", "native_adrenaline_locked")' "$client/KillAttributionClient.cs"
