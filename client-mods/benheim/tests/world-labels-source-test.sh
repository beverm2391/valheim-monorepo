...
grep -Fq 'TryGetNativeTextDonor(out NativeTextDonor donor)' "$module/PortalLabelController.cs"
grep -Fq 'TryRememberPrefabDonor(scene.m_prefabs, out donor)' "$module/WorldLabelRuntime.cs"
grep -Fq 'TryRememberPrefabDonor(scene.m_nonNetViewPrefabs, out donor)' "$module/WorldLabelRuntime.cs"
grep -Fq 'RememberNativeTextDonor(sign.m_textWidget' "$module/WorldLabelRuntime.cs"
grep -Fq 'Portal label text donor resolved from' "$module/WorldLabelRuntime.cs"
...
grep -Fq 'label.fontSharedMaterial = donor.Material;' "$module/PortalLabelController.cs"
