...
grep -Fq 'public Skills.SkillType m_skill = Skills.SkillType.Cooking;' "$native_station"
grep -Fq 'public bool m_canGiveBonusYield = true;' "$native_station"
...
grep -Fq 'station.m_skill == Skills.SkillType.Cooking' "$source_file"
grep -Fq 'station.m_canGiveBonusYield' "$source_file"
grep -Fq 'EnterCookingStation' "$source_file"
grep -Fq 'RestoreCookingStation' "$source_file"
