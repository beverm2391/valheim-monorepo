...
grep -Fq 'AudioSourceCurveType.SpatialBlend' "$activation_audio"
grep -Fq 'AnimationCurve.Linear(0f, 1f, 1f, 1f)' "$activation_audio"
grep -Fq 'audioSource.rolloffMode = AudioRolloffMode.Linear;' "$activation_audio"
