...
# Valheim 1.0.12 owns the complete comfort calculation. Its isolated helper
...
rg -Fq 'contributors, {ignoredCount} ignored' "$summary"
rg -Fq '{snapshot.RadiusExclusionCount} just outside range' "$summary"
rg -Fq 'Native prefilter: not observable.' "$summary"
