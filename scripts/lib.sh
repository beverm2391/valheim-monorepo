...
VALHEIM_MODDED=${VALHEIM_MODDED:-0}
VALHEIM_PORTALS=${VALHEIM_PORTALS:-}
VALHEIM_SKILL_GAIN_RATE=${VALHEIM_SKILL_GAIN_RATE:-}
VALHEIM_SKILL_REDUCTION_RATE=${VALHEIM_SKILL_REDUCTION_RATE:-}
