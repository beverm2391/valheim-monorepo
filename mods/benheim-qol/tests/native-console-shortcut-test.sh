...
grep -Fq 'InputState.IsKeyDown(KeyCode.Slash)' "$shortcut"
grep -Fq '!console.IsConsoleEnabled()' "$shortcut"
grep -Fq 'console.m_chatWindow.gameObject.SetActive(true);' "$shortcut"
grep -Fq 'console.m_input.ActivateInputField();' "$shortcut"
