...
grep -Fq 'multiplayer_requires_authoritative_transaction' "$quick_stack"
grep -Fq 'Put Away is temporarily unavailable in multiplayer' "$quick_stack"
grep -Fq 'IsTrueSinglePlayer()' "$quick_stack"
