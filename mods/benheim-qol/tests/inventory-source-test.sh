...
grep -Fq 'AbovePlayerDurationSeconds = 6f' "$quick_stack_feedback"
grep -Fq 'TopLeftRefreshDelaySeconds = 3f' "$quick_stack_feedback"
...
grep -Fq 'WorldTextDurationField.SetValue' "$feedback"
