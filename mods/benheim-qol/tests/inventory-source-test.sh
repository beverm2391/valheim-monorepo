...
grep -Fq 'multiplayer_requires_authoritative_transaction' "$quick_stack_availability"
grep -Fq 'Put Away is temporarily unavailable in multiplayer' "$quick_stack_availability"
