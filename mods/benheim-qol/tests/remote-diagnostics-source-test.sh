...
grep -Fq 'name == "station"' "$event"
grep -Fq 'name.EndsWith("_id", StringComparison.Ordinal) && name != "operation_id"' "$event"
grep -Fq 'name == "position"' "$event"
grep -Fq 'name != "error"' "$event"
grep -Fq 'name != "chat"' "$event"
grep -Fq 'name != "ip_address"' "$event"
grep -Fq 'name != "token"' "$event"
grep -Fq 'name != "file_path"' "$event"
