...
rg -Fq '? "grounded"' "$logic"
rg -Fq '? "rising_or_apex"' "$logic"
rg -Fq ': "insufficient_approach"' "$logic"
rg -Fq '.Number("vertical_speed", verticalSpeed)' "$logic"
rg -Fq '.Number("descent_threshold", AirborneMeleeTuning.DescentThreshold)' "$logic"
rg -Fq '.Number("toward_target_speed", towardTargetSpeed)' "$logic"
rg -Fq '.Number("approach_threshold", AirborneMeleeTuning.ApproachSpeedThreshold)' "$logic"
