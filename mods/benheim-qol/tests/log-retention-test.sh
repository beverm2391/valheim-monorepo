...
#!/bin/sh
case "\$2" in
  *BenheimLogArchive*) printf 'partial archive\n' > "\$2"; exit 42 ;;
esac
exec "$real_cp" "\$@"
SH
chmod +x "$mock_bin/cp"
...
run_launcher
wait_for_new_session
grep -Fq 'Warning: Could not archive the previous BepInEx log; continuing launch.' "$test_root/home/Library/Logs/BenheimQoL/launch.log"
