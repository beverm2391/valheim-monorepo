...
mod_root="$root/server-mods/benheim-inventory"
...
dotnet build "$mod_root/src/BenheimInventory.csproj" \
...
install -m 0644 \
  "$mod_root/src/bin/Release/netstandard2.1/BenheimInventory.dll" \
  "$mod_root/dist/BenheimInventory.dll"

shasum -a 256 "$mod_root/dist/BenheimInventory.dll"
